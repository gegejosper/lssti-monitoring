            ...
            <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-header border-0 py-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="text-muted mt-3 font-weight-bold font-size-sm">Report for employees penalties <br> <br> 
                    ...
                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                        ...
                        <div class="m-0">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6244760677ea6" style="">
                                ...
                                <form action="{{route ('panel.admin.report_penalties_range')}}" method="post">
                                    <!--begin::Form-->
                                    @csrf
                                    <div class="px-7 py-5">
                                        <!--begin::Input group-->
                            ...
                            <table class="table table-head-custom table-head-bg table-borderless table-vertical-center" id="employeeTable">
                                ...
                                <tbody>
                                    @foreach($employee_logs as $employee_log)
                                        ...
                                        <td id="row_penalty_{{$employee_log->id}}">{{number_format($employee_log->penalty_amount,2)}}</td>
